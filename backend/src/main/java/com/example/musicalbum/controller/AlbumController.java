...
public class AlbumController {
    ...
    public List<Album> findAllAlbums() {
        log.info("[ GET /api/albums ] :: get all albums' list");
    ...
    public Album findById(@PathVariable Long id) {
        log.info("[ GET /api/albums/{} ] :: get album by id", id);
    ...
    public String saveAlbum(@RequestBody Album album) {
        ...
        log.info("[ POST /api/albums ] :: added new album: {}", album.getTitle());
    ...
    public Album updateAlbum(@PathVariable Long id, @RequestBody Album album) {
        log.info("[ PUT /api/albums/{} ] :: album update request", id);
    ...
    public void deleteAlbum(@PathVariable Long id) {
        log.info("[ DELETE /api/albums/{} ] album is deleted by id", id);
